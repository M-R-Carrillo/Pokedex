...
import tkinter as tk  #Libreria para hacer interfaz grafica
import urllib3
...
#configuracion de la interfaz grafica a partir
#de la libreria tk --- sintaxis: tk.tk()
...
title_label = tk.Label(window, text= "NeuralNine Poxedex")
